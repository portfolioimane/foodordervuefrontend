...
export default {
    ...
    methods: {
        ...
        async saveImage(e) {
            ...
            imageData.append('upload_preset', 'foodlaravelordering')
            imageData.append('cloud', 'ddjfwp9wf')

            try {
                const result = await this.$axios.post(`https://api.cloudinary.com/v1_1/ddjfwp9wf/image/upload`, imageData);
